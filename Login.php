    ...
    <div class="row"><br>
      <div class="col-sm-4"></div>
        <div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:#f4ac41;"><br>
        	...
        	<h1 align="center"><b><font style="font-family: 'Libre Baskerville', serif;text-shadow:3px 3px #000;">Login de Usuario</font></b></h1>
          ...
          <div class="form-group forget">
                <a href="Forgot account.php">Olvido su Cuenta</a>&nbsp; <b>|</b>&nbsp; 
                <a href="Registation form.php">Crear una Cuenta</a>
            </div>
      	</form><br>
        </div>
    </div><br>
